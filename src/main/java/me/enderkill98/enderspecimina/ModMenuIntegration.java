        ...
        return parentScreen -> YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(text("Map IDs based on Name-Hashes: Debug Logging"))
                                        .binding(Config.HANDLER.defaults().mapIdNameHashesDebug, () -> Config.HANDLER.instance().mapIdNameHashesDebug, (newVal) -> Config.HANDLER.instance().mapIdNameHashesDebug = newVal)
                                        .description(textOptDesc("Enables logging actions done by the above feature. Useful for troubleshooting."))
                                        .controller(TickBoxControllerBuilder::create)
                                        .build()
                                )
                                .option(Option.<Boolean>createBuilder()
